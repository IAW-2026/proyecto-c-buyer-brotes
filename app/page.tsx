...
export default async function Home() {
  ...
  const images = {
    jardinVertical: getImagesFromFolder('ImagenPared'),
    escritorioVerde: getImagesFromFolder('ImagenEscritorio'),
    balconUrbano: getImagesFromFolder('ImagenBalcon')
  }
    ...
    <main className="min-h-screen" style={{ backgroundColor: '#F5F2EA' }}>
          ...
          <div className="rounded-[2rem] border border-white/80 bg-[#F8FFF6]/90 p-6 sm:p-8 shadow-[0_40px_80px_rgba(36,59,39,0.08)]">
            <div className="grid gap-6">
              ...
              <div className="rounded-[1.75rem] bg-white border border-[#EAF3E6] p-6 transition-all duration-300 hover:shadow-lg hover:scale-[1.02] cursor-pointer">
                ...
                <p className="mt-3 text-sm" style={{ color: '#4C6B3D' }}>
                  Descubrí plantas y estilos frescos que renuevan cualquier espacio.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="px-8 py-8">
        <div className="max-w-6xl mx-auto">
          <nav className="text-sm mb-4" style={{ color: '#7BA05D' }}>
            ...
            <span style={{ color: '#4C6B3D' }}>Viveros destacados</span>
          </nav>
      ...
      <section className="px-8 py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <Link href="/explorar?tipo=suculentas" className="rounded-2xl bg-white p-6 text-center shadow-sm border border-[#EAF3E6] transition-all duration-300 hover:shadow-lg hover:scale-105">
          ...
          <Link href="/explorar?tipo=interior" className="rounded-2xl bg-white p-6 text-center shadow-sm border border-[#EAF3E6] transition-all duration-300 hover:shadow-lg hover:scale-105">
          ...
          <Link href="/explorar?tipo=accesorios" className="rounded-2xl bg-white p-6 text-center shadow-sm border border-[#EAF3E6] transition-all duration-300 hover:shadow-lg hover:scale-105">
          ...
          <Link href="/explorar?tipo=raras" className="rounded-2xl bg-white p-6 text-center shadow-sm border border-[#EAF3E6] transition-all duration-300 hover:shadow-lg hover:scale-105">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-105 cursor-pointer">
              <div className="relative h-40 rounded-xl mb-3 overflow-hidden bg-[#F1FAF1]">
                {images.jardinVertical.length > 0 ? (
                  <ImagenCarousel imagenes={images.jardinVertical} alt="Jardín vertical" />
                ) : (
            ...
            <div className="rounded-2xl bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-105 cursor-pointer">
              <div className="relative h-40 rounded-xl mb-3 overflow-hidden bg-[#F1FAF1]">
                {images.escritorioVerde.length > 0 ? (
                  <ImagenCarousel imagenes={images.escritorioVerde} alt="Escritorio verde" />
                ) : (
                  <div className="flex h-full items-center justify-center">
            ...
            <div className="rounded-2xl bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-105 cursor-pointer">
              <div className="relative h-40 rounded-xl mb-3 overflow-hidden bg-[#F1FAF1]">
                {images.balconUrbano.length > 0 ? (
                  <ImagenCarousel imagenes={images.balconUrbano} alt="Balcón urbano" />
                ) : (
                  <div className="flex h-full items-center justify-center">
